...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%------------------------------------------------------%
function MPCR_Pedestrian_Detection
...
for loop=1:500
    ...
    w1 = w1 + 0.001*rand(size(w1));
    w2 = w2 + 0.001*rand(size(w2));
    
%     w1 = w1 - 0.1*rand(size(w1));
%     w2 = w2 - 0.1*rand(size(w2));
%     
%     
%     w1=w1/norm(w1);
%     w2=w2/norm(w2);
...
%     
    ...
    [loop b (1-(sse2/length(testcategory)))*100 (1-(sse3/length(validcategory)))*100]
